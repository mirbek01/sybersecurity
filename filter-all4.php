...
<script src="/BD/123/1234/jquery.min.js"></script> 
<script src="/BD/123/1234/FileSaver.js"></script> 
<script src="/BD/123/1234/jquery.wordexport.js"></script> 
<script type="text/javascript">
...
<th>Oper	</th>
<th>Стыковка оперы	</th>
<th>Имя пользователя	</th>
<th>Учетная запись в AD	</th>
<th>Имя ПК	</th>
<th>T_NETADDR	</th>
<th>Дата входа	</th>
<th>Время входа</th>
<th>Мак адрес	</th>
<th>Тип действии (повторный вход)	</th>
<th>ID prosess	</th>
    ...
    <tr class='table-filters'>
		...
		{echo " <tr class='table-data'>  <td> ".$array ['T_USERID']."</td><td> ".$array ['T_OPER']."</td><td> ".$array ['T_NAME']."</td><td> ".$array ['T_USERNAME']."</td><td> ".$array ['T_COMPNAME']."</td><td> ".$array ['T_NETADDR']."</td><td> ".$array ['T_DATE']."</td><td> ".$array ['T_TIME']."</td><td> ".$array ['T_SADDR']."</td><td> ".$array ['T_opcode']."</td><td> ".$array ['T_PROCESSID']."</td></tr> ";   } }		?>  
